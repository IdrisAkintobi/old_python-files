...
with open("jare.csv", "w") as file:
    file_writer = DictWriter(file, fieldnames=[
                             "Firstname", "Lastname", "Age"], delimiter="|", lineterminator="\n")
    file_writer.writeheader()
    file_writer.writerow(
        {"Firstname": "Idris", "Lastname": "Akintobi", "Age": 84})
    file_writer.writerow(
        {"Firstname": "Aminat", "Lastname": "Adepoju", "Age": 78})
